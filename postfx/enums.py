...
class Theme(metaclass=_ThemeNamespace):
    ...
    class Grain(StrEnum):
        """Texture-only looks measured from published social stills — grain the
        way a platform-compressed phone photo carries it, colour untouched.
        Chain a Signature theme before one for a look."""
