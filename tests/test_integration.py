...
def test_process_file_end_to_end(tmp_path, rgb_image):
    ...
    result = postfx.process_file(src, dst, theme="portra_400",
                                 condition="day_outdoor", strength=1.0)
...
def test_process_file_same_input_same_output(tmp_path, rgb_image):
    ...
    a = tmp_path / "a.png"
    b = tmp_path / "b.png"
    postfx.process_file(src, a, theme="cinestill_800t", condition="night_flash")
    postfx.process_file(src, b, theme="cinestill_800t", condition="night_flash")
